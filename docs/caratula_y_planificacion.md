...
| **Hito 4: Frontend Desktop Fluent** | 13 Sep — 22 Sep | 7 vistas PyQt5 + QFluentWidgets, `m5_cards_interface.py` (Simulador de Torniquetes OMNY), diálogos modales en flota e incidentes. | Interfaz fluida a 60 FPS con threading asíncrono. Soporte para temas Claro/Oscuro y simulación en vivo de cobro y recarga. |
