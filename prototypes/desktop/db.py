"""
Data Access Module for the MetroNY Desktop Application (Oracle Database).
Direct connection with automatic PDB detection (FREEPDB1 / XEPDB1).
"""
import os
import oracledb
...
def get_connection():
    """
    Returns an active connection to Oracle Database with PDB fallback.
    """
    global ACTIVE_PDB
    ...
    raise RuntimeError(f"Could not connect to Oracle at {DB_HOST}:{DB_PORT}. Error: {last_error}")
...
# 15 mandatory queries catalogue
CONSULTAS_CATALOGO = {
    1: {
